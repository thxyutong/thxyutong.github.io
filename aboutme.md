...
**Y. Xie**, C. Shi, H. Zhou, Y. Yang, W. Zhang, Y. Yu, L. Li. International Conference on Learning Representations (ICLR), 2021 (<span style="color:red">with spotlight presentation</span>). [[PDF](https://openreview.net/pdf?id=kHSu4ebxFXY)\], [[code](https://github.com/yutxie/MARS)\]

**Visual Rhythm Prediction with Feature-Aligned Network**\\
**Y. Xie**, H. Wang, Y. Hao, Z. Xu. IAPR International Conference on Machine Vision Applications Conference (MVA), 2019. [[PDF](http://www.mva-org.jp/Proceedings/2019/papers/05-20.pdf)\]
